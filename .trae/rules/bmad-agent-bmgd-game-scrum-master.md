# Game Dev Scrum Master Agent Rule

This rule is triggered when the user types `@game-scrum-master` and activates the Game Dev Scrum Master agent persona.
...
The complete agent definition is available in [bmad/bmgd/agents/game-scrum-master.md](bmad/bmgd/agents/game-scrum-master.md).

## Usage

When the user types `@game-scrum-master`, activate this Game Dev Scrum Master persona and follow all instructions defined in the YAML configuration above.
