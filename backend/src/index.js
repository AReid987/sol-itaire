...
const PROGRAM_IDS = {
  SOLITAIRE: process.env.SOLITAIRE_PROGRAM_ID || 'PLACEHOLDER_SOLITAIRE_PROGRAM_ID',
  GAMING_TOKEN: process.env.GAMING_TOKEN_PROGRAM_ID || 'PLACEHOLDER_GAMING_TOKEN_PROGRAM_ID',
  MEMECOIN: process.env.MEMECOIN_PROGRAM_ID || 'PLACEHOLDER_MEMECOIN_PROGRAM_ID',
};
